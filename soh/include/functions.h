...
void CollisionCheck_SpawnShieldParticlesMetalSfx(PlayState* play, Vec3f* v, Vec3f* actorPos);
...
void Audio_PlayCutsceneEffectsSequence(u8);
...
void Message_StartOcarina(PlayState* play, u16 arg1);
void Message_StartOcarinaSunsSongDisabled(PlayState* play, u16 arg1);
