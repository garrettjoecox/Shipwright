...
GameStateOverlay gGameStateOverlayTable[] = {
    ...
    GAMESTATE_OVERLAY(select, MapSelect_Init, MapSelect_Destroy, sizeof(SelectContext)),
    ...
    GAMESTATE_OVERLAY(file_choose, FileSelect_Init, FileSelect_Destroy, sizeof(FileChooseContext)),
};
