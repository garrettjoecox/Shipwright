...
void DbCamera_Update(DbCamera* dbCamera, Camera* cam) {
    ...
    *sp90 = temp_s6->pos;
    ...
    if (CHECK_BTN_ALL(sPlayState->state.input[2].press.button, BTN_Z)) {
        ...
        sDbCamAnim.unk_0A = 0;
        Audio_PlaySfxGeneral(NA_SE_SY_LOCK_ON, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
            ...
            *sp80 = cam->eye;
            ...
            if (CHECK_BTN_ALL(sPlayState->state.input[2].press.button, BTN_R) &&
                ...
                if (dbCamera->sub.unkIdx == 0x80) {
                    ...
                    Audio_PlaySfxGeneral(NA_SE_IT_SWORD_PUTAWAY, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale,
                                           &gSfxDefaultReverb);
                    ...
                    if ((1 << sCurFileIdx) & sMempakFiles) {
                        ...
                        if (CHECK_BTN_ALL(sPlayState->state.input[2].press.button, BTN_A)) {
                            if (dbCamera->sub.demoCtrlToggleSwitch == 0) {
                                ...
                                Audio_PlaySfxGeneral(NA_SE_SY_CANCEL, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale,
                                                       &gSfxDefaultReverb);
