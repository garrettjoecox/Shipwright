...
u8 EnMd_ShouldSpawn(EnMd* this, PlayState* play) {
    ...
    if (gSaveContext.n64ddFlag) {
        ...
        if (Flags_GetEventChkInf(EVENTCHKINF_SHOWED_MIDO_SWORD_SHIELD) &&
            ...
            return play->sceneId == SCENE_MIDOS_HOUSE && !LINK_IS_ADULT;
        }

        return play->sceneId == SCENE_KOKIRI_FOREST;
    }
...
void EnMd_Init(Actor* thisx, PlayState* play) {
    ...
    if (((play->sceneId == SCENE_KOKIRI_FOREST) && !Flags_GetEventChkInf(EVENTCHKINF_SHOWED_MIDO_SWORD_SHIELD)) ||
        ((play->sceneId == SCENE_KOKIRI_FOREST) && (Flags_GetEventChkInf(EVENTCHKINF_SHOWED_MIDO_SWORD_SHIELD)) &&
        ...
        ((play->sceneId == SCENE_LOST_WOODS) && !Flags_GetEventChkInf(EVENTCHKINF_PLAYED_SARIAS_SONG_FOR_MIDO_AS_ADULT))) {
