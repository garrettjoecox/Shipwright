    ...
    if (this->introState != BFD_CS_NONE) {
        ...
        switch (this->introState) {
            ...
            case BFD_CS_LOOK_LINK:
                ...
                if (this->timers[0] < 50) {
                    Audio_PlaySfxGeneral(NA_SE_EN_DODO_K_ROLL - SFX_FLAG, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
    ...
    switch (this->work[BFD_ACTION_STATE]) {
        ...
        case BOSSFD_DROP_ROCKS:
            ...
            if (this->timers[1] == 0) {
                ...
                if (this->actor.bgCheckFlags & 0x10) {
                    ...
                    this->timers[1] = 10;
                    Audio_PlaySfxGeneral(NA_SE_EV_EXPLOSION, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale,
                                           &gSfxDefaultReverb);
        ...
        case BOSSFD_SKIN_BURN:
            ...
            if (this->skinSegments != 0) {
                ...
                if (this->work[BFD_MOVE_TIMER] & 0x1C) {
                    Audio_PlaySfxGeneral(NA_SE_EN_VALVAISA_BURN - SFX_FLAG, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                                           &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                }
            ...
            if (this->timers[0] == 0) {
                if (this->actor.world.pos.y <= 110.0f) {
                    ...
                    if (this->work[BFD_CEILING_TARGET] == 0) {
                        ...
                        Audio_PlaySfxGeneral(NA_SE_EN_VALVAISA_LAND2, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                                               &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
        ...
        case BOSSFD_SKULL_BURN:
            ...
            if ((50 > this->timers[0]) && (this->timers[0] > 0)) {
                ...
                Audio_PlaySfxGeneral(NA_SE_EN_GOMA_LAST - SFX_FLAG, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                                       &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
...
void BossFd_Effects(BossFd* this, PlayState* play) {
    ...
    if (this->work[BFD_ROAR_TIMER] != 0) {
        if (this->work[BFD_ROAR_TIMER] == 37) {
            Audio_PlaySfxGeneral(NA_SE_EN_VALVAISA_ROAR, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale,
                                   &gSfxDefaultReverb);
        }
        jawAngle = 6000.0f;
        jawSpeed = 1300.0f;
    ...
    if (this->timers[4] != 0) {
        ...
        Audio_PlaySfxGeneral(NA_SE_EN_VALVAISA_APPEAR - SFX_FLAG, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                               &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
    ...
    if (breathOpacity != 0) {
        ...
        Audio_PlaySfxGeneral(NA_SE_EN_VALVAISA_FIRE - SFX_FLAG, &sFireAudioVec, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale,
                               &gSfxDefaultReverb);
...
void BossFd_CollisionCheck(BossFd* this, PlayState* play) {
    ...
    if (headCollider->info.bumperFlags & BUMP_HIT) {
        ...
        Audio_PlaySfxGeneral(NA_SE_EN_VALVAISA_DAMAGE1, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale,
                               &gSfxDefaultReverb);
    }
}
