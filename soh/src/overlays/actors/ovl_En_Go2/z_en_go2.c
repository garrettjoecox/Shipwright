...
s32 EnGo2_IsRollingOnGround(EnGo2* this, s16 arg1, f32 arg2, s16 arg3) {
    ...
    if (this->unk_59C >= 2) {
        Actor_PlaySfx(&this->actor, (this->actor.params & 0x1F) == GORON_CITY_ROLLING_BIG
...
void EnGo2_CurledUp(EnGo2* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->skelAnime, this->skelAnime.endFrame)) {
        if ((this->actor.params & 0x1F) == GORON_DMT_BIGGORON) {
            ...
            Quake_SetPerturbations(quake, 8, 0, 0, 0);
