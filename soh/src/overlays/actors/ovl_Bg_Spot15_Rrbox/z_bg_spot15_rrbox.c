...
s32 func_808B3CA0(BgSpot15Rrbox* this, PlayState* play, s32 arg2) {
    ...
    this->dyna.actor.floorHeight = BgCheck_EntityRaycastDown6(&play->colCtx, &this->dyna.actor.floorPoly,
...
f32 func_808B3DDC(BgSpot15Rrbox* this, PlayState* play) {
    ...
    for (i = 0; i < ARRAY_COUNT(D_808B45DC); i++) {
        ...
        yIntersect = BgCheck_EntityRaycastDown6(&play->colCtx, &actor->floorPoly, &bgId, actor, &position, 0);
