...
RandomizerCheck Randomizer_GetCheckFromActor(s16 actorId, s16 sceneId, s16 actorParams);
ScrubIdentity Randomizer_IdentifyScrub(s32 sceneId, s32 actorParams, s32 respawnData);
ShopItemIdentity Randomizer_IdentifyShopItem(s32 sceneId, u8 slotIndex);
CowIdentity Randomizer_IdentifyCow(s32 sceneId, s32 posX, s32 posZ);
...
GetItemEntry Randomizer_GetItemFromActor(s16 actorId, s16 sceneId, s16 actorParams, GetItemID ogId);
GetItemEntry Randomizer_GetItemFromActorWithoutObtainabilityCheck(s16 actorId, s16 sceneId, s16 actorParams, GetItemID ogId);
