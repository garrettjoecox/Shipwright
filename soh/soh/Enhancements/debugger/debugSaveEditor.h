...
const std::vector<FlagTable> flagTables = {
    ...
    { "Randomizer Inf Flags", RANDOMIZER_INF, 16, {
        ...
        { RAND_INF_CHEST_GAME_DOOR_1, "RAND_INF_CHEST_GAME_DOOR_1"},
        { RAND_INF_CHEST_GAME_DOOR_2, "RAND_INF_CHEST_GAME_DOOR_2"},
        { RAND_INF_CHEST_GAME_DOOR_3, "RAND_INF_CHEST_GAME_DOOR_3"},
        { RAND_INF_CHEST_GAME_DOOR_4, "RAND_INF_CHEST_GAME_DOOR_4"},
        { RAND_INF_CHEST_GAME_DOOR_5, "RAND_INF_CHEST_GAME_DOOR_5"},
        { RAND_INF_CHEST_GAME_DOOR_6, "RAND_INF_CHEST_GAME_DOOR_6"},
    } },
};
