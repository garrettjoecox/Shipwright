...
std::vector<SplitObject> splitObjectList = {
    ...
    { SPLIT_ITEM, 	    ITEM_OCARINA_TIME, 		                "Ocarina of Time", 						"ITEM_OCARINA_TIME", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BOMBCHU, 	 		                "Bombchu", 								"ITEM_BOMBCHU", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_HOOKSHOT,  		                "Hookshot", 							"ITEM_HOOKSHOT", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_LONGSHOT,  		                "Longshot", 							"ITEM_LONGSHOT", 				COLOR_WHITE },
    ...
    { SPLIT_ITEM, 	    ITEM_POTION_RED,  		                "Red Potion", 							"ITEM_POTION_RED", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_POTION_GREEN,  	                "Green Potion", 						"ITEM_POTION_GREEN", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_POTION_BLUE,  		                "Blue Potion", 							"ITEM_POTION_BLUE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_FAIRY,  			                "Bottled Fairy", 						"ITEM_FAIRY", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_FISH,  			                "Fish", 								"ITEM_FISH", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MILK_BOTTLE,  		                "Milk", 				                "ITEM_MILK_BOTTLE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_LETTER_RUTO,  		                "Ruto's Letter", 						"ITEM_LETTER_RUTO", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BLUE_FIRE,  		                "Blue Fire", 							"ITEM_BLUE_FIRE", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BUG,  				                "Bug", 									"ITEM_BUG", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BIG_POE,  			                "Big Poe", 								"ITEM_BIG_POE", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_POE,  				                "Poe", 									"ITEM_POE", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_WEIRD_EGG,  		                "Weird Egg", 							"ITEM_WEIRD_EGG", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_CHICKEN,  			                "Chicken", 								"ITEM_CHICKEN", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_LETTER_ZELDA,  	                "Zelda's Letter", 						"ITEM_LETTER_ZELDA", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_KEATON,  		                "Keaton Mask", 							"ITEM_MASK_KEATON", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_SKULL,  		                "Skull Mask", 							"ITEM_MASK_SKULL", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_SPOOKY,  		                "Spooky Mask", 							"ITEM_MASK_SPOOKY", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_BUNNY,  		                "Bunny Hood", 							"ITEM_MASK_BUNNY", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_GORON,  		                "Goron Mask", 							"ITEM_MASK_GORON", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_ZORA,  		                "Zora Mask", 							"ITEM_MASK_ZORA", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_GERUDO,  		                "Gerudo Mask", 							"ITEM_MASK_GERUDO", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MASK_TRUTH,  		                "Mask of Truth", 						"ITEM_MASK_TRUTH", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_POCKET_EGG,  		                "Pocket Egg", 							"ITEM_POCKET_EGG", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_POCKET_CUCCO,  	                "Pocket Cucco", 						"ITEM_POCKET_CUCCO", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_COJIRO,  			                "Cojiro", 								"ITEM_COJIRO", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_ODD_MUSHROOM,  	                "Odd Mushroom", 						"ITEM_ODD_MUSHROOM", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_ODD_POTION,  		                "Odd Potion", 							"ITEM_ODD_POTION", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SAW,  				                "Poacher's Saw", 						"ITEM_SAW", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SWORD_BROKEN,  	                "Goron's Sword (Broken)", 				"ITEM_SWORD_BROKEN", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_PRESCRIPTION,  	                "Prescription", 						"ITEM_PRESCRIPTION", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_FROG,  			                "Eyeball Frog", 						"ITEM_FROG", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_EYEDROPS,  		                "Eye Drops", 							"ITEM_EYEDROPS", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_CLAIM_CHECK,  		                "Claim Check",  						"ITEM_CLAIM_CHECK", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SWORD_KOKIRI,  	                "Kokiri Sword", 						"ITEM_SWORD_KOKIRI", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SWORD_MASTER,  	                "Master Sword", 						"ITEM_SWORD_MASTER", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SWORD_BGS,  		                "Giant's Knife & Biggoron's Sword", 	"ITEM_SWORD_BGS", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SHIELD_DEKU,  		                "Deku Shield", 							"ITEM_SHIELD_DEKU", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SHIELD_HYLIAN, 	                "Hylian Shield", 						"ITEM_SHIELD_HYLIAN", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SHIELD_MIRROR, 	                "Mirror Shield", 						"ITEM_SHIELD_MIRROR", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_TUNIC_GORON,  		                "Goron Tunic", 							"ITEM_TUNIC_GORON", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_TUNIC_ZORA,  		                "Zora Tunic", 							"ITEM_TUNIC_ZORA", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BOOTS_IRON,  		                "Iron Boots", 							"ITEM_BOOTS_IRON", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BOOTS_HOVER,  		                "Hover Boots", 							"ITEM_BOOTS_HOVER", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BULLET_BAG_30, 	                "Bullet Bag (30)", 						"ITEM_BULLET_BAG_30", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BULLET_BAG_40, 	                "Bullet Bag (40)", 						"ITEM_BULLET_BAG_40", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BULLET_BAG_50, 	                "Bullet Bag (50)", 						"ITEM_BULLET_BAG_50", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_QUIVER_30,  		                "Quiver (30)", 							"ITEM_QUIVER_30", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_QUIVER_40,  		                "Big Quiver (40)", 						"ITEM_QUIVER_40", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_QUIVER_50,  		                "Biggest Quiver (50)", 					"ITEM_QUIVER_50", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BOMB_BAG_20,  		                "Bomb Bag (20)", 						"ITEM_BOMB_BAG_20", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BOMB_BAG_30,  		                "Big Bomb Bag (30)", 					"ITEM_BOMB_BAG_30", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BOMB_BAG_40,  		                "Biggest Bomb Bag (40)", 				"ITEM_BOMB_BAG_40", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_BRACELET,  		                "Goron's Bracelet", 					"ITEM_BRACELET", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_GAUNTLETS_SILVER,                  "Silver Gauntlets", 					"ITEM_GAUNTLETS_SILVER", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_GAUNTLETS_GOLD,  	                "Golden Gauntlets", 					"ITEM_GAUNTLETS_GOLD", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SCALE_SILVER,  	                "Silver Scale", 						"ITEM_SCALE_SILVER", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SCALE_GOLDEN,  	                "Golden Scale", 						"ITEM_SCALE_GOLDEN", 			COLOR_WHITE },
    ...
    { SPLIT_ITEM, 	    ITEM_WALLET_GIANT,  	                "Giant's Wallet", 						"ITEM_WALLET_GIANT", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_FISHING_POLE,  	                "Fishing Pole", 						"ITEM_FISHING_POLE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_MINUET,  		                "Minuet of Forest",						"QUEST_SONG_MINUET", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_BOLERO,  		                "Bolero of Fire", 						"QUEST_SONG_BOLERO", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_SERENADE,  	                "Serenade of Water", 					"QUEST_SONG_SERENADE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_REQUIEM,  	                "Requiem of Spirit", 					"QUEST_SONG_REQUIEM", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_NOCTURNE,  	                "Nocturne of Shadow", 					"QUEST_SONG_NOCTURNE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_PRELUDE,  	                "Prelude of Light", 					"QUEST_SONG_PRELUDE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_LULLABY,  	                "Zelda's Lullaby", 						"QUEST_SONG_LULLABY", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_EPONA,  		                "Epona's Song", 						"QUEST_SONG_EPONA", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_SARIA,  		                "Saria's Song", 						"QUEST_SONG_SARIA", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_SUN,  		                "Sun's Song", 							"QUEST_SONG_SUN", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_TIME, 		                "Song of Time", 						"QUEST_SONG_TIME", 				COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SONG_STORMS, 		                "Song of Storms", 						"QUEST_SONG_STORMS", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MEDALLION_FOREST, 	                "Forest Medallion", 					"QUEST_MEDALLION_FOREST", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MEDALLION_FIRE, 	                "Fire Medallion", 						"QUEST_MEDALLION_FIRE", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MEDALLION_WATER, 	                "Water Medallion", 						"QUEST_MEDALLION_WATER", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MEDALLION_SPIRIT, 	                "Spirit Medallion", 					"QUEST_MEDALLION_SPIRIT", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MEDALLION_SHADOW, 	                "Shadow Medallion", 					"QUEST_MEDALLION_SHADOW", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_MEDALLION_LIGHT, 	                "Light Medallion", 						"QUEST_MEDALLION_LIGHT", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_KOKIRI_EMERALD, 	                "Kokiri's Emerald", 					"QUEST_KOKIRI_EMERALD", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_GORON_RUBY, 		                "Goron's Ruby", 						"QUEST_GORON_RUBY", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_ZORA_SAPPHIRE, 	                "Zora's Sapphire", 						"QUEST_ZORA_SAPPHIRE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_STONE_OF_AGONY, 	                "Stone of Agony", 						"QUEST_STONE_OF_AGONY", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_GERUDO_CARD, 		                "Gerudo's Card", 						"QUEST_GERUDO_CARD", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SKULL_TOKEN,                       "Skulltula Token",                      "QUEST_SKULL_TOKEN", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_SINGLE_MAGIC, 		                "Magic Meter", 							"ITEM_MAGIC_SMALL", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_DOUBLE_MAGIC, 		                "Double Magic", 				        "ITEM_MAGIC_LARGE", 			COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_DOUBLE_DEFENSE, 	                "Double Defense", 						"ITEM_HEART_CONTAINER", 		COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_STICK_UPGRADE_20, 	                "Deku Stick Upgrade (20)", 				"ITEM_STICK", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_STICK_UPGRADE_30, 	                "Deku Stick Upgrade (30)", 				"ITEM_STICK", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_NUT_UPGRADE_30, 	                "Deku Nut Upgrade (30)", 				"ITEM_NUT", 					COLOR_WHITE },
    { SPLIT_ITEM, 	    ITEM_NUT_UPGRADE_40, 	                "Deku Nut Upgrade (40)", 				"ITEM_NUT", 					COLOR_WHITE },
